...
@Service
@AllArgsConstructor
public class MailLogServiceImpl extends BaseServiceImpl<SysMailLogDao, SysMailLogEntity> implements SysMailLogService {

    @Override
    public PageResult<MailLogVO> page(SysMailLogQuery query) {
