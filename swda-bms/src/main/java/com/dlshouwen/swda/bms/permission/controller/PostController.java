 ...
 */
@RestController
@RequestMapping("/bms/permission/post")
@Tag(name = "post")
@AllArgsConstructor
...
//		return page result
	...
	@PreAuthorize("hasAuthority('bms:permission:post:list')")
...
//		return
	...
	@PreAuthorize("hasAuthority('bms:permission:post:data')")
...
//		return post
	...
	@PreAuthorize("hasAuthority('bms:permission:post:add')")
